...
| _this commit_ | P-RC-6 P6.2a | refactor(agent/safety): scaffold agent/safety package + destructive-intent classifier (extracted from core.agent) | +310 (new agent/safety/__init__.py + destructive_intent.py with 7 helpers) | 0 (tests follow in P6.2c) | ADR-0002, ADR-0003 |
